...
# ── PAGE CV (/app?page=cv) ────────────────────────────────────────
if st.query_params.get("page") == "cv":
    st.markdown("""
<style>
...
<div style="background:#09090b;min-height:100vh;padding:60px 5% 80px;font-family:'Inter',sans-serif">
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;
    ...
    <div style="background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.15);
         border-radius:14px;padding:18px 12px">
      <div style="font-size:2rem;font-weight:900;color:#f59e0b">13</div>
    ...
    <div>
      ...
      <div style="position:relative;padding-left:20px">
        ...
        <div style="position:relative;margin-bottom:22px">
          ...
          <div style="background:rgba(16,185,129,0.05);border:1px solid rgba(16,185,129,0.12);border-radius:12px;padding:14px 16px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:5px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.85rem">Head of IT &amp; Lecturer</div>
              <span style="font-size:0.62rem;background:rgba(16,185,129,0.1);color:#10b981;border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:6px">2023 – Présent</span>
            </div>
            <div style="color:#10b981;font-size:0.76rem;font-weight:600;margin-bottom:6px">ERIDAN SCHOOL · Montpellier</div>
        ...
        <div style="position:relative;margin-bottom:22px">
          ...
          <div style="background:rgba(59,130,246,0.04);border:1px solid rgba(59,130,246,0.12);border-radius:12px;padding:14px 16px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:5px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.85rem">Research Bioinformatician L4 / Data Manager</div>
              <span style="font-size:0.62rem;background:rgba(59,130,246,0.1);color:#3b82f6;border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:6px">2023 – 2024</span>
            </div>
            <div style="color:#3b82f6;font-size:0.76rem;font-weight:600;margin-bottom:6px">Centre de Recherche · CHU Sainte-Justine · Montréal</div>
            <ul style="color:#64748b;font-size:0.74rem;line-height:1.7;padding-left:14px">
              <li>Préparation des données CNV (*.idat/*.cel) pour la détection de variants</li>
              <li>Annotation génomique et protocole ML DigCNV</li>
              <li>Intégration des données génomiques dans des études cliniques</li>
            </ul>
          </div>
        </div>
        ...
        <div style="position:relative;margin-bottom:22px">
          ...
          <div style="background:rgba(139,92,246,0.04);border:1px solid rgba(139,92,246,0.12);border-radius:12px;padding:14px 16px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:5px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.85rem">Ingénieur Bioinformatique / Chef de projet Biostatistiques</div>
              <span style="font-size:0.62rem;background:rgba(139,92,246,0.1);color:#8b5cf6;border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:6px">2021 – 2022</span>
            </div>
            <div style="color:#8b5cf6;font-size:0.76rem;font-weight:600;margin-bottom:6px">UCA, Faculté de Médecine · Nice</div>
            <ul style="color:#64748b;font-size:0.74rem;line-height:1.7;padding-left:14px">
              <li>Développement de pipelines automatisés pour données NGS</li>
              <li>Modélisation prédictive, analyses différentielles, pathway analysis</li>
            </ul>
          </div>
        </div>
        ...
        <div style="position:relative;margin-bottom:22px">
          ...
          <div style="background:rgba(245,158,11,0.04);border:1px solid rgba(245,158,11,0.12);border-radius:12px;padding:14px 16px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:5px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.85rem">Doctorant — Bioinformatique &amp; Génomique</div>
              <span style="font-size:0.62rem;background:rgba(245,158,11,0.1);color:#f59e0b;border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:6px">2017 – 2020</span>
            </div>
            <div style="color:#f59e0b;font-size:0.76rem;font-weight:600;margin-bottom:6px">IHU Méditerranée Infection · Aix-Marseille Université</div>
            <ul style="color:#64748b;font-size:0.74rem;line-height:1.7;padding-left:14px">
              <li>Phylogénomique, taxonomie microbienne, mosaïcisme génomique</li>
              <li>20+ publications dans des revues internationales</li>
            </ul>
          </div>
        </div>
        ...
        <div style="position:relative">
          ...
          <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:14px 16px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:5px">
              ...
              <span style="font-size:0.62rem;background:rgba(100,116,139,0.1);color:#64748b;border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:6px">2015 – 2016</span>
            </div>
            <div style="color:#64748b;font-size:0.76rem;font-weight:600;margin-bottom:6px">CHU FANN · Dakar, Sénégal</div>
            <ul style="color:#64748b;font-size:0.74rem;line-height:1.7;padding-left:14px">
              <li>IRM : traitement d'images médicales (FSL/SPM)</li>
              <li>Gestion BDD hospitalières (MySQL), interfaces PHP/HTML</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div style="display:flex;flex-direction:column;gap:40px">
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          <div style="background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.15);border-radius:12px;padding:14px 16px;display:flex;gap:12px;align-items:center">
            <div style="min-width:48px;text-align:center;background:rgba(16,185,129,0.1);border-radius:8px;padding:5px 0;font-size:0.7rem;font-weight:800;color:#10b981">2020</div>
            <div><div style="font-weight:700;color:#e2e8f0;font-size:0.82rem">PhD Informatique &amp; Bioinformatique</div>
            <div style="color:#64748b;font-size:0.72rem;margin-top:2px">Aix-Marseille Université</div></div>
          </div>
          <div style="background:rgba(59,130,246,0.04);border:1px solid rgba(59,130,246,0.1);border-radius:12px;padding:14px 16px;display:flex;gap:12px;align-items:center">
            <div style="min-width:48px;text-align:center;background:rgba(59,130,246,0.1);border-radius:8px;padding:5px 0;font-size:0.7rem;font-weight:800;color:#3b82f6">2019</div>
            <div><div style="font-weight:700;color:#e2e8f0;font-size:0.82rem">CESU Biostatistiques &amp; Méthodologie de la Recherche</div>
            <div style="color:#64748b;font-size:0.72rem;margin-top:2px">Faculté de Médecine · Aix-Marseille</div></div>
          </div>
          <div style="background:rgba(139,92,246,0.04);border:1px solid rgba(139,92,246,0.1);border-radius:12px;padding:14px 16px;display:flex;gap:12px;align-items:center">
            <div style="min-width:48px;text-align:center;background:rgba(139,92,246,0.1);border-radius:8px;padding:5px 0;font-size:0.7rem;font-weight:800;color:#8b5cf6">2017</div>
            <div><div style="font-weight:700;color:#e2e8f0;font-size:0.82rem">M2 Bioinformatique &amp; Biomathématiques</div>
            <div style="color:#64748b;font-size:0.72rem;margin-top:2px">Université Cheikh Anta Diop · Dakar</div></div>
          </div>
          <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:14px 16px;display:flex;gap:12px;align-items:center">
            <div style="min-width:48px;text-align:center;background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 0;font-size:0.7rem;font-weight:800;color:#64748b">2014</div>
            <div><div style="font-weight:700;color:#cbd5e1;font-size:0.82rem">Licence Biologie, Chimie &amp; Géosciences</div>
            <div style="color:#64748b;font-size:0.72rem;margin-top:2px">Université Cheikh Anta Diop · Dakar</div></div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:16px">
          <div>
            <div style="font-size:0.62rem;color:#10b981;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:8px">Langages</div>
            <div style="display:flex;flex-wrap:wrap;gap:6px">
              <span style="background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.2);color:#10b981;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Python</span>
              <span style="background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.2);color:#3b82f6;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">R</span>
              <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:#94a3b8;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Shell/Bash</span>
              <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:#94a3b8;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">PHP / JS</span>
            </div>
          </div>
          <div>
            <div style="font-size:0.62rem;color:#3b82f6;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:8px">Machine Learning</div>
            <div style="display:flex;flex-wrap:wrap;gap:6px">
              <span style="background:rgba(139,92,246,0.08);border:1px solid rgba(139,92,246,0.2);color:#8b5cf6;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Scikit-learn</span>
              <span style="background:rgba(139,92,246,0.06);border:1px solid rgba(139,92,246,0.15);color:#a78bfa;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Classification</span>
              <span style="background:rgba(139,92,246,0.06);border:1px solid rgba(139,92,246,0.15);color:#a78bfa;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">PCA</span>
            </div>
          </div>
          <div>
            <div style="font-size:0.62rem;color:#f59e0b;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:8px">Bioinformatique</div>
            <div style="display:flex;flex-wrap:wrap;gap:6px">
              <span style="background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.2);color:#f59e0b;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">GATK</span>
              <span style="background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.15);color:#fbbf24;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Snakemake</span>
              <span style="background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.15);color:#fbbf24;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Nextflow</span>
              <span style="background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.15);color:#fbbf24;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Bowtie2</span>
            </div>
          </div>
          <div>
            <div style="font-size:0.62rem;color:#64748b;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:8px">Cloud &amp; DevOps</div>
            <div style="display:flex;flex-wrap:wrap;gap:6px">
              <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:#94a3b8;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">GCP</span>
              <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:#94a3b8;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Docker</span>
              <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:#94a3b8;border-radius:20px;padding:3px 10px;font-size:0.7rem;font-weight:600">Git/GitLab</span>
            </div>
          </div>
        </div>
        <div style="display:flex;gap:10px;margin-top:8px">
          <div style="flex:1;background:rgba(16,185,129,0.05);border:1px solid rgba(16,185,129,0.12);border-radius:12px;padding:12px;text-align:center">
          ...
          <div style="flex:1;background:rgba(59,130,246,0.05);border:1px solid rgba(59,130,246,0.12);border-radius:12px;padding:12px;text-align:center">
            <div style="font-size:1.3rem;margin-bottom:4px">🇬🇧</div>
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:8px">
          <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:12px 14px">
            <div style="color:#cbd5e1;font-size:0.76rem;font-weight:600;margin-bottom:3px">Epidemiology and genomic characterisation of influenza — Marseille</div>
            <div style="color:#64748b;font-size:0.7rem">Travel Med Infect Dis · 2022 · PMID 34921995</div>
          </div>
          <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:12px 14px">
            <div style="color:#cbd5e1;font-size:0.76rem;font-weight:600;margin-bottom:3px">Spatiotemporal Dynamic of the RTS,S/AS01 Malaria Vaccine Target Antigens in Senegal</div>
            <div style="color:#64748b;font-size:0.7rem">Am J Trop Med Hyg · 2021 · PMID 34634772</div>
          </div>
          <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:12px 14px">
            <div style="color:#cbd5e1;font-size:0.76rem;font-weight:600;margin-bottom:3px">Optimization and standardization of the culturomics technique for human microbiome</div>
            <div style="color:#64748b;font-size:0.7rem">Sci Rep · 2020 · PMID 32541790</div>
          </div>
          <a href="https://scholar.google.com/citations?user=qJaCV7MAAAAJ&hl=fr" target="_blank"
             style="text-align:center;background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.2);
                    color:#f59e0b;border-radius:10px;padding:10px;font-size:0.74rem;font-weight:700;
                    text-decoration:none;display:block;margin-top:4px">
            Voir les 29 publications · Google Scholar ↗
          </a>
        </div>
      </div>
  ...
  <!-- footer -->
  <div style="text-align:center;margin-top:64px;padding-top:32px;border-top:1px solid rgba(255,255,255,0.06)">
...
_hero_html = (
    ...
    '<div style="font-size:2.4rem;font-weight:900;color:#fafafa;line-height:1;letter-spacing:-1.5px">13</div>'
    ...
    <div style="padding:0 0 56px 40px;background:#0c0c0e">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:20px">
        <div style="background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.12);
          ...
          <div style="font-size:1.6rem;font-weight:900;color:#10b981;line-height:1">13</div>
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:14px">
        ...
        <a href="https://medflowailanding.streamlit.app/?page=cv" target="_blank"
