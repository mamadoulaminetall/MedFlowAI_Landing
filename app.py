...
st.markdown(
    ...
    '<div class="nav-item">'
    '<a class="nav-link" href="#cv">Parcours</a>'
    '</div>'
...
# ─────────────────────────────────────────────────────────────────
# CV — Parcours & Expertise
# ─────────────────────────────────────────────────────────────────
_ticker_sep()
st.markdown("<div id='cv'></div>", unsafe_allow_html=True)
st.markdown("""
<section style="background:linear-gradient(180deg,#09090b 0%,#0c0c0e 40%,#09090b 100%);
  ...
  <div style="text-align:center;margin-bottom:64px">
    <div style="font-size:0.7rem;font-weight:700;letter-spacing:3.5px;
         text-transform:uppercase;color:#10b981;margin-bottom:14px">Curriculum Vitæ</div>
    <h2 style="font-size:2.8rem;font-weight:900;color:#f1f5f9;
               letter-spacing:-1.2px;line-height:1.1;margin-bottom:16px">
      Parcours &amp;
      <span style="background:linear-gradient(135deg,#10b981,#34d399);
            -webkit-background-clip:text;-webkit-text-fill-color:transparent">Expertise</span>
    </h2>
    <p style="color:#64748b;font-size:1rem;max-width:560px;margin:0 auto;line-height:1.7">
      PhD Bioinformatique · Aix-Marseille 2020 · 29 publications · 248+ citations
    </p>
  </div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;max-width:1200px;margin:0 auto">
    ...
    <div>
      <div style="font-size:0.68rem;font-weight:700;letter-spacing:3px;text-transform:uppercase;
           color:#10b981;margin-bottom:24px;display:flex;align-items:center;gap:10px">
        <div style="width:28px;height:28px;background:rgba(16,185,129,0.12);border-radius:8px;
      ...
      <div style="position:relative;padding-left:24px">
        <div style="position:absolute;left:7px;top:8px;bottom:0;width:2px;
                    background:linear-gradient(180deg,#10b981,rgba(16,185,129,0.1))"></div>

        <!-- poste 1 -->
        <div style="position:relative;margin-bottom:28px">
          <div style="position:absolute;left:-24px;top:6px;width:10px;height:10px;
                      border-radius:50%;background:#10b981;
                      box-shadow:0 0 0 3px rgba(16,185,129,0.2)"></div>
          <div style="background:rgba(16,185,129,0.05);border:1px solid rgba(16,185,129,0.12);
               border-radius:14px;padding:16px 18px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.88rem">Head of IT &amp; Lecturer</div>
              <span style="font-size:0.65rem;background:rgba(16,185,129,0.1);color:#10b981;
                    border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:8px">2023–Présent</span>
            </div>
            <div style="color:#10b981;font-size:0.78rem;font-weight:600;margin-bottom:4px">ERIDAN SCHOOL · Montpellier</div>
            <div style="color:#64748b;font-size:0.75rem;line-height:1.6">
              Responsable IT et enseignant en Sciences Numériques &amp; Informatique (école bilingue internationale).
            </div>
          </div>
        </div>
        ...
        <div style="position:relative;margin-bottom:28px">
          <div style="position:absolute;left:-24px;top:6px;width:10px;height:10px;
                      ...
                      box-shadow:0 0 0 3px rgba(59,130,246,0.2)"></div>
          <div style="background:rgba(59,130,246,0.05);border:1px solid rgba(59,130,246,0.12);
               border-radius:14px;padding:16px 18px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.88rem">Research Bioinformatician L4 / Data Manager</div>
              <span style="font-size:0.65rem;background:rgba(59,130,246,0.1);color:#3b82f6;
                    border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:8px">2023–2024</span>
            </div>
            <div style="color:#3b82f6;font-size:0.78rem;font-weight:600;margin-bottom:4px">CHU Sainte-Justine · Montréal, Canada</div>
            <div style="color:#64748b;font-size:0.75rem;line-height:1.6">
              Pipelines CNV (DigCNV), traitement *.idat/*.cel, annotation génomique, intégration en études cliniques.
            </div>
          </div>
        </div>
        ...
        <div style="position:relative;margin-bottom:28px">
          <div style="position:absolute;left:-24px;top:6px;width:10px;height:10px;
                      ...
                      box-shadow:0 0 0 3px rgba(139,92,246,0.2)"></div>
          <div style="background:rgba(139,92,246,0.05);border:1px solid rgba(139,92,246,0.12);
               border-radius:14px;padding:16px 18px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.88rem">Ingénieur Bioinformatique / Chef de projet Biostat.</div>
              <span style="font-size:0.65rem;background:rgba(139,92,246,0.1);color:#8b5cf6;
                    border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:8px">2021–2022</span>
            </div>
            <div style="color:#8b5cf6;font-size:0.78rem;font-weight:600;margin-bottom:4px">UCA, Faculté de Médecine / DERMG · Nice</div>
            <div style="color:#64748b;font-size:0.75rem;line-height:1.6">
              Développement de méthodes analytiques, pipelines NGS, modélisation prédictive de biomarqueurs diagnostiques.
            </div>
          </div>
        </div>
        ...
        <div style="position:relative;margin-bottom:28px">
          <div style="position:absolute;left:-24px;top:6px;width:10px;height:10px;
                      ...
                      box-shadow:0 0 0 3px rgba(245,158,11,0.2)"></div>
          <div style="background:rgba(245,158,11,0.05);border:1px solid rgba(245,158,11,0.12);
               border-radius:14px;padding:16px 18px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px">
              <div style="font-weight:700;color:#e2e8f0;font-size:0.88rem">Doctorant en Bioinformatique &amp; Génomique</div>
              <span style="font-size:0.65rem;background:rgba(245,158,11,0.1);color:#f59e0b;
                    border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:8px">2017–2020</span>
            </div>
            <div style="color:#f59e0b;font-size:0.78rem;font-weight:600;margin-bottom:4px">IHU Méditerranée Infection · Aix-Marseille</div>
            <div style="color:#64748b;font-size:0.75rem;line-height:1.6">
              Mosaïcisme génomique microbien, transferts horizontaux de gènes, phylogénomique, 20+ publications.
            </div>
          </div>
        </div>
        ...
        <div style="position:relative">
          <div style="position:absolute;left:-24px;top:6px;width:10px;height:10px;
                      ...
                      box-shadow:0 0 0 3px rgba(100,116,139,0.2)"></div>
          <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);
               border-radius:14px;padding:16px 18px">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px">
              <div style="font-weight:700;color:#cbd5e1;font-size:0.88rem">Stages cliniques &amp; hospitaliers</div>
              <span style="font-size:0.65rem;background:rgba(100,116,139,0.1);color:#64748b;
                    border-radius:20px;padding:2px 8px;white-space:nowrap;margin-left:8px">2015–2016</span>
            </div>
            <div style="color:#64748b;font-size:0.78rem;font-weight:600;margin-bottom:4px">CHU FANN · Dakar, Sénégal</div>
            <div style="color:#64748b;font-size:0.75rem;line-height:1.6">
              IRM (FSL/SPM) · Gestion BDD hospitalières (MySQL, PHP/HTML).
            </div>
          </div>
        </div>
    ...
    <!-- ── COLONNE DROITE : Formation + Compétences ── -->
    <div style="display:flex;flex-direction:column;gap:36px">

      <!-- FORMATION -->
      <div>
        <div style="font-size:0.68rem;font-weight:700;letter-spacing:3px;text-transform:uppercase;
             color:#3b82f6;margin-bottom:24px;display:flex;align-items:center;gap:10px">
          <div style="width:28px;height:28px;background:rgba(59,130,246,0.12);border-radius:8px;
               display:flex;align-items:center;justify-content:center;font-size:0.9rem">🎓</div>
          Formation
        </div>
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          ...
          <div style="background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.15);
               border-radius:12px;padding:14px 16px;display:flex;gap:14px;align-items:flex-start">
            <div style="min-width:52px;text-align:center;background:rgba(16,185,129,0.1);
                 border-radius:8px;padding:4px 0;font-size:0.72rem;font-weight:800;color:#10b981">2020</div>
            <div>
              <div style="font-weight:700;color:#e2e8f0;font-size:0.83rem">PhD Informatique &amp; Bioinformatique</div>
              <div style="color:#64748b;font-size:0.74rem;margin-top:2px">Aix-Marseille Université · France</div>
            </div>
          </div>

          <div style="background:rgba(59,130,246,0.04);border:1px solid rgba(59,130,246,0.1);
               border-radius:12px;padding:14px 16px;display:flex;gap:14px;align-items:flex-start">
            <div style="min-width:52px;text-align:center;background:rgba(59,130,246,0.1);
                 border-radius:8px;padding:4px 0;font-size:0.72rem;font-weight:800;color:#3b82f6">2019</div>
            <div>
              <div style="font-weight:700;color:#e2e8f0;font-size:0.83rem">CESU Biostatistiques &amp; Méthodologie</div>
              <div style="color:#64748b;font-size:0.74rem;margin-top:2px">Faculté de Médecine · Aix-Marseille</div>
            </div>
          </div>

          <div style="background:rgba(139,92,246,0.04);border:1px solid rgba(139,92,246,0.1);
               border-radius:12px;padding:14px 16px;display:flex;gap:14px;align-items:flex-start">
            <div style="min-width:52px;text-align:center;background:rgba(139,92,246,0.1);
                 border-radius:8px;padding:4px 0;font-size:0.72rem;font-weight:800;color:#8b5cf6">2017</div>
            <div>
              <div style="font-weight:700;color:#e2e8f0;font-size:0.83rem">M2 Bioinformatique &amp; Biomathématiques</div>
              <div style="color:#64748b;font-size:0.74rem;margin-top:2px">Université Cheikh Anta Diop · Dakar</div>
            </div>
          </div>

          <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);
               border-radius:12px;padding:14px 16px;display:flex;gap:14px;align-items:flex-start">
            <div style="min-width:52px;text-align:center;background:rgba(255,255,255,0.06);
                 border-radius:8px;padding:4px 0;font-size:0.72rem;font-weight:800;color:#64748b">2014</div>
            <div>
              <div style="font-weight:700;color:#cbd5e1;font-size:0.83rem">Licence Biologie, Chimie &amp; Géosciences</div>
              <div style="color:#64748b;font-size:0.74rem;margin-top:2px">Université Cheikh Anta Diop · Dakar</div>
            </div>
          </div>
      ...
      <div>
        <div style="font-size:0.68rem;font-weight:700;letter-spacing:3px;text-transform:uppercase;
             color:#8b5cf6;margin-bottom:20px;display:flex;align-items:center;gap:10px">
          <div style="width:28px;height:28px;background:rgba(139,92,246,0.12);border-radius:8px;
        ...
        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:16px">
          <span style="background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.2);
                color:#10b981;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Python</span>
          <span style="background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.2);
                color:#3b82f6;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">R</span>
          <span style="background:rgba(139,92,246,0.08);border:1px solid rgba(139,92,246,0.2);
                color:#8b5cf6;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Machine Learning</span>
          <span style="background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.2);
                color:#f59e0b;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Bioinformatique NGS</span>
          <span style="background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.15);
                color:#34d399;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Snakemake / Nextflow</span>
          <span style="background:rgba(59,130,246,0.06);border:1px solid rgba(59,130,246,0.15);
                color:#60a5fa;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Docker / CI-CD</span>
          <span style="background:rgba(139,92,246,0.06);border:1px solid rgba(139,92,246,0.15);
                color:#a78bfa;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">GCP / AWS</span>
          <span style="background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.15);
                color:#fbbf24;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">MySQL / PostgreSQL</span>
          <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);
                color:#94a3b8;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Shell / Bash</span>
          <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);
                color:#94a3b8;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Streamlit / FastAPI</span>
          <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);
                color:#94a3b8;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">GATK / Samtools</span>
          <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);
                color:#94a3b8;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">GDPR / AI Act</span>
          <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);
                color:#94a3b8;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Agile / Scrum</span>
          <span style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);
                color:#94a3b8;border-radius:20px;padding:4px 12px;font-size:0.72rem;font-weight:600">Power BI</span>
        </div>
        ...
        <div style="display:flex;gap:10px;margin-top:4px">
          <div style="flex:1;background:rgba(16,185,129,0.05);border:1px solid rgba(16,185,129,0.12);
            ...
            <div style="font-weight:700;color:#e2e8f0;font-size:0.8rem">Français</div>
            <div style="color:#10b981;font-size:0.68rem;margin-top:2px">Natif</div>
          </div>
          <div style="flex:1;background:rgba(59,130,246,0.05);border:1px solid rgba(59,130,246,0.12);
               border-radius:12px;padding:12px 16px;text-align:center">
            <div style="font-size:1.2rem;margin-bottom:4px">🇬🇧</div>
            <div style="font-weight:700;color:#e2e8f0;font-size:0.8rem">English</div>
            <div style="color:#3b82f6;font-size:0.68rem;margin-top:2px">Professionnel</div>
          </div>
        </div>
      </div><!-- /compétences -->
  ...
  <div style="text-align:center;margin-top:56px">
    <a href="https://github.com/mamadoulaminetall" target="_blank"
       style="display:inline-flex;align-items:center;gap:8px;
              ...
              border-radius:12px;padding:12px 28px;font-size:0.85rem;font-weight:700;
              text-decoration:none;transition:all 0.2s">
    ...
    <a href="https://scholar.google.com/citations?user=qJaCV7MAAAAJ&hl=fr" target="_blank"
       style="display:inline-flex;align-items:center;gap:8px;
              ...
              border-radius:12px;padding:12px 28px;font-size:0.85rem;font-weight:700;
              text-decoration:none;transition:all 0.2s">
      29 publications · Google Scholar ↗
    </a>
  </div>
